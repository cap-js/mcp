...
function checkAuthorization(srv) {
  ...
  // Filter out auto-exposed, draft, and @cds.api.ignore entities
  let entities = Object.fromEntries(
    Object.entries(srv.entities || {})
      .filter(([name, entity]) => !name.endsWith('DraftAdministrativeData') && !name.endsWith('.texts') && !entity['@cds.api.ignore'])
  )
