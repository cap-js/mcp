  ...
  router.post('/', async (req, res) => {
    try {
      ...
      if (entityCount > 0 || actionCount > 0) {
        ...
        const registerActionTool = cds.env.features?.mcp_per_action_tool ? registerPerActionTools : registerCallActionTool;
      ...
      const transport = new StreamableHTTPServerTransport({
        ...
        enableJsonResponse: cds.env.features?.mcp_json_response ?? false
      })
