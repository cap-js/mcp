...
function getInstructions(def, locale, prefix_) {
  ...
  return custom ||
  `Use the \`${prefix_}describe\` tool to explore the data model and available actions/functions.`+
  `Then use \`${prefix_}query\` to read data or \`${prefix_}call\` to invoke actions or functions.`
