...
function createReadInputSchema(options = {}) {
  ...
  schema.offset = z.number().int().min(0).optional()
    .describe('Number of results to skip before returning rows (OFFSET / $skip). Use together with limit and orderBy for stable pagination.')
