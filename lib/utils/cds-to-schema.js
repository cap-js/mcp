...
const HAVING_DESCRIPTION = `CQN having clause for filtering grouped results. Same format as where but applied after GROUP BY.
Commonly used with aggregate functions to filter groups.
